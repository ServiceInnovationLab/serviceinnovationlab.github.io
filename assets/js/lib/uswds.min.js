...
})(
  {
        ...
        !(function(e, n) {
                  ...
                  (u = s[f]),
                    Oe.test(u.type || '') &&
                      ...
                      (u.src
                        ...
                        : oe.globalEval(u.textContent.replace(Xe, '')));
            }
            return e;
          }
          function C(e, t, n) {
          ...
          var ce = (function(e) {
            function t(e, t, n, r) {
              ...
              if (
                !r &&
                ((t ? t.ownerDocument || t : $) !== L && q(t), (t = t || L), P)
              ) {
                if (11 !== g && (l = ve.exec(e)))
                  if ((i = l[1])) {
                    if (9 === g) {
            ...
            function y(e) {
              for (
                ...
                if ((n = T.relative[e[a].type])) c = [d(h(c), n)];
                  ...
                  if (
                    ((n = T.filter[e[a].type].apply(null, e[a].matches)), n[W])
                  ) {
              ...
              var i = n.length > 0,
                ...
                s = function(r, s, a, u, l) {
                  ...
                  for (
                    ...
                    if (o && c) {
                      for (
                        f = 0, s || c.ownerDocument === L || (q(c), (a = !P));
                        (p = e[f++]);
          ...
          oe.extend({
            ...
            (oe.cssHooks.marginRight = S(re.reliableMarginRight, function(
              e,
              t,
            ) {
              return t
          ...
          (re.cors = !!Pt && 'withCredentials' in Pt),
            (re.ajax = Pt = !!Pt),
        ...
        !(function(e) {
          ...
          var t = function(e) {
            ...
            e.getAttribute &&
              ...
              (this.delimiter =
                this.element.getAttribute('data-delimiter') || ' '),
              (this.reverse =
                null !== this.element.getAttribute('data-reverse')),
              (this.groupLength =
                this.element.getAttribute('data-grouplength') || 3));
          };
          (t.prototype._divideIntoArray = function(e) {
            for (
              var t,
                n,
                r,
                i = ('' + this.groupLength).split(','),
                o = 1 === i.length,
                s = [],
                a = 0;
              i.length && a < e.length;
              ...
              (t = o ? i[0] : i.shift() || e.length - a),
                (r = Math.min(parseInt(t, 10), e.length - a)),
                (n = this.reverse ? -1 * (r + a) : a),
                s.push(e.substr(n, r)),
                (a += r);
            return this.reverse && s.reverse(), s;
          }),
            (t.prototype.format = function(e) {
              var t = this.unformat(e);
              return this._divideIntoArray(t).join(this.delimiter);
            }),
            (t.prototype.trimMaxlength = function(e) {
              var t = this.element.getAttribute('maxlength');
              return t && (e = e.substr(0, t)), e;
            }),
            (t.prototype.getValue = function() {
              return this.trimMaxlength(this.element.value);
            }),
            (t.prototype.update = function() {
              this.element.value = this.useProxy()
                ? this.getValue()
                : this.format(this.getValue());
            }),
            (t.prototype.unformat = function(e) {
              return e.replace(new RegExp(this.delimiter, 'g'), '');
            }),
            (t.prototype.reset = function() {
              this.element.value = this.unformat(this.element.value);
            }),
            (t.prototype.useProxy = function() {
              return 'number' === this.type;
            }),
            (t.prototype.updateProxy = function() {
              var e;
              this.useProxy() &&
                ((e = this.element.parentNode.firstChild),
                (e.innerHTML = this.format(this.getValue())),
                (e.style.width = this.element.offsetWidth + 'px'));
            }),
            (t.prototype.createProxy = function() {
              function e(e, t) {
                return window.getComputedStyle(e, null).getPropertyValue(t);
              }
              function t(t, n) {
                for (var r = 0, i = 0, o = n.length; o > i; i++)
                  r += parseFloat(e(t, n[i]));
                return r;
              }
              if (this.useProxy()) {
                ...
                (i.style.font = e(this.element, 'font')),
                  (i.style.paddingLeft =
                    t(this.element, ['padding-left', 'border-left-width']) +
                    'px'),
                  (i.style.paddingRight =
                    t(this.element, ['padding-right', 'border-right-width']) +
                    'px'),
                  (i.style.top =
                    t(this.element, [
                      'padding-top',
                  ...
                  r.appendChild(i),
                  (r.className = 'politespace-proxy active');
                var o = n.replaceChild(r, this.element);
                r.appendChild(o), this.updateProxy();
              }
            }),
            (e.Politespace = t);
        })(this);
    ...
    3: [
      function(e, t, n) {
        function r(e) {
          var t = this;
          (this.$root = e),
            this.$root.on('click', 'button', function(e) {
              var n = i(this),
                r = 'true' === n.attr('aria-expanded');
              e.preventDefault(), t.hideAll(), r || t.show(n);
            });
          var n = this.$('button[aria-expanded=true]');
          this.hideAll(), n.length && this.show(n);
        }
        var i = e('jquery');
        (r.prototype.$ = function(e) {
          ...
          (r.prototype.hide = function(e) {
            var t = e.attr('aria-controls'),
              n = this.$('#' + t);
            return e.attr('aria-expanded', !1), n.attr('aria-hidden', !0), this;
          }),
          (r.prototype.show = function(e) {
            var t = e.attr('aria-controls'),
              n = this.$('#' + t);
            return e.attr('aria-expanded', !0), n.attr('aria-hidden', !1), this;
          }),
          (r.prototype.hideAll = function() {
            var e = this;
            return (
    ...
    5: [
      function(e, t, n) {
        ...
        var i = e('./toggle-field-mask.js'),
          o = function(e, t, n) {
            var o = e.attr('aria-controls');
            ...
            var s = r(o),
              a = e.parents('form').find(s),
              u = !1;
            e.on('click', function(r) {
              r.preventDefault(), i(a, u), e.text(u ? t : n), (u = !u);
            });
          };
        t.exports = o;
      },
      { './toggle-field-mask.js': 4 },
    ],
    6: [
      function(e, t, n) {
        var r = e('jquery');
          ...
          function t() {
            for (n in a)
              n.startsWith('validate') &&
                ((i = n.split('validate')[1]),
                (o = new RegExp(a[n])),
                (s = u.find('[data-validator=' + i.toLowerCase() + ']')),
                o.test(e.val())
                  ? s.toggleClass('usa-checklist-checked', !0)
                  : s.toggleClass('usa-checklist-checked', !1));
          }
          var n,
            i,
            o,
    ...
    7: [
      function(e, t, n) {
        'use strict';
        var r = (window.jQuery = e('jquery')),
          i = e('./components/accordion'),
          o = e('./components/validator'),
          s = e('./components/toggle-form-input'),
          a = e('../../node_modules/politespace/src/politespace').Politespace;
        r(function() {
          var e = 'politespace';
          (r.fn[e] = function() {
            return this.each(function() {
              var t = new a(this);
              'number' === t.type && t.createProxy(),
                r(this)
            ...
            r(document).ready(function() {
              r('[data-' + e + ']').politespace();
            }),
            r('.usa-accordion,.usa-accordion-bordered').each(function() {
              new i(r(this));
            });
          var t = function() {
            window.innerWidth < 600
              ? (r('.usa-footer-big nav ul').addClass('hidden'),
                r('.usa-footer-big nav .usa-footer-primary-link').unbind(
                  'click',
                ),
                r('.usa-footer-big nav .usa-footer-primary-link').bind(
                  'click',
                  function() {
                    r(this)
                      .parent()
              ...
              : (r('.usa-footer-big nav ul').removeClass('hidden'),
                r('.usa-footer-big nav .usa-footer-primary-link').unbind(
                  'click',
                ));
          };
          t(),
            r(window).resize(t),
            r('.skipnav').click(function() {
              r('#main-content').attr('tabindex', '0');
            }),
            r('#main-content').blur(function() {
              r(this).attr('tabindex', '-1');
            });
          var n = r('.usa-show_password'),
            u = r('.usa-show_multipassword'),
            l = r('.js-validate_password');
          n.length && s(n, 'Show Password', 'Hide Password'),
            u.length && s(u, 'Show my typing', 'Hide my typing'),
            l.length && o(l);
        });
      },
      {
        '../../node_modules/politespace/src/politespace': 2,
        './components/accordion': 3,
        './components/toggle-form-input': 5,
        './components/validator': 6,
        jquery: 1,
      },
    ],
  },

...
Link: The Toolkit 2.0 (information sharing) is at http://serviceinnovationtoolkit.wikidot.com/ as a temporary collaboration tool.</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">Status: Complete. Cross channel and possibly cross agency service analytics were identified as a high value evidence base to inform service design and delivery, to measure impact of new, changed or retired digital services, and to understand the user journey across channels and domains. This deliverable was to consult with agencies, learn their user needs around service analytics, design a basic POC and prioritise based on the agency needs. The user needs was completed here and a small POC completed by 30 June (below).<br>
